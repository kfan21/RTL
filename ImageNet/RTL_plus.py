...
args.save_dirs = "./ood_results/reduced_method_{}_dim_{}_alpha_{}_wo_slice_new".format(args.reduce_method, args.reduce_dim, args.alpha)
os.makedirs(args.save_dirs, exist_ok = True)
args.save_files = ["./ood_results/reduced_method_{}_dim_{}_alpha_{}_wo_slice_new/score_{}_percent_{}.csv".format(args.reduce_method, args.reduce_dim, args.alpha, args.score , i) for i in args.percent]
...
def get_dataset_results(ood_feature, ood_score, ood_name):
    ...
    final_scores = rtl_ood.reranking_list(in_and_out_feature, in_and_out_score, args.percent, args.alpha)

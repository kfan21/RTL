...
parser.add_argument('--percent', type=str, default = "no,linear", help='percent of sample used')
...
args.percent = [i for i in args.percent.split(",")]
args.save_dirs = ["./ood_results_linear/method_{}/score_{}/exp_num_{}/alpha_{}/percent_{}".format(args.method_name, args.score, args.exp_num, args.alpha, i) for i in args.percent]
...
def get_and_print_results(ood_loader, num_to_avg=args.num_to_avg):
    ...
    for _ in range(num_to_avg):
        ...
        score_cal = rtl_ood.linear(in_and_out_feature, in_and_out_score, args.percent, args.alpha)
